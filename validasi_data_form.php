    ...
    <?php 
      ...
      // if (mysqli_num_rows($result) > 0 ) { 
        while($data = mysqli_fetch_array($result)){
          ...
          $nama_penguji3 = $data["nama_penguji3"];

          $foto_usulan = $data["foto_usulan"];
          $status_data = $data["status_data"];
        }
    ?>
    <?php echo "<form role='form' method='post' action='validasi_data_process.php?id=".$id."'' autocomplete='off'>"?>
    <div class="box-body">
      <!-- <div class="row"> -->
      <div class="col-md-12">                 
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-6" >
          <div class="form-group">
            ...
            <textarea type="text" class="form-control" name="judul" style="width: 100%; height: 107px;" readonly><?php echo $judul;?></textarea>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="jam" value="<?php echo $jam;?>" readonly>
          </div>
          <div class="form-group">
            <label for="ruang">Ruang Ujian</label>
            <input type="text" class="form-control" name="ruang" value="<?php echo $ruang;?>" readonly>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <!-- <img src="<?php echo $foto_usulan;?>" name="image" alt="<?php echo str_replace('upload/'.$id.'/', '', $foto_usulan)?>" height="500px" align="middle"> -->
        ...
        <div class="col-md-6" >
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="ketua" value="<?php echo $nama_ketua;?>" readonly>
          </div>
          <div class="form-group">
            <label for="sekretaris">Sekretaris</label>
            <input type="text" class="form-control" name="sekretaris" value="<?php echo $nama_sekretaris;?>" readonly>
          </div>
          <div class="form-group">
            <label for="penguji1">Penguji 1</label>
            <input type="text" class="form-control" name="penguji1" value="<?php echo $nama_penguji1;?>" readonly>
          </div>
          <div class="form-group">
            <label for="penguji2">Penguji 2</label>
            <input type="text" class="form-control" name="penguji2" value="<?php echo $nama_penguji2;?>" readonly>
          </div>
          <div class="form-group">
            <label for="penguji3">Penguji 3</label>
            <input type="text" class="form-control" name="penguji3" value="<?php echo $nama_penguji3;?>" readonly>
          </div>
        </div>
      <!-- /.col -->
      </div>
      <div class="col-md-12">
        <h3 class="box-title">Status Data : <?php echo $status_data;?></h3>
      </div>
      <!-- /.box-body -->
    </div>
