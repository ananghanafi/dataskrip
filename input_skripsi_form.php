  ...
  <div class="content-wrapper">
    ...
    <?php
      if ($_SESSION['role']=='student') {
        include "inpskr_std.php";
    ?>
    <!-- <div class="box-body">
    <h4>AdminLTE Custom Tabs</h4>
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_baru" data-toggle="tab">Data Baru</a></li>
              <li disabled><a href="#tab_edit" data-toggle="tab">Edit Data</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_baru">              
              <?php //include "inpskr_std.php";?>
              </div>

              <div class="tab-pane" id="tab_edit">
              <?php //include "edtskr_std.php";?>
              </div>              
            </div>
          </div>
        </div>
